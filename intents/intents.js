...
const intents = {
  getArrivals: async (stopId, body) => {
    ...
    const noRouteHeard = `
      <speak>
        I\'m sorry which route are you asking about?
      </speak>`;
  ...
  notUser: body => {
    const speech = `
      <speak>
        What is your bus stop four digit id?
        It can be found either in the one bus away app or on the sign at the stop.
      </speak>`;
